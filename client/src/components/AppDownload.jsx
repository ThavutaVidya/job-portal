...
const AppDownload = () => {
  return (
    <div className='container px-4 2xl:px-20 my-20 mx-auto '>
      <div className='relative p-12 sm:p-24 lg:p-32 bg-gradient-to-r from-violet-50 to-purple-50 rounded'>
        <div>
        ...
        <img className='absolute right-0 bottom-0 mr-32 max-sm:hidden' src={assets.app_main_img} alt="" />
      </div>
    </div>
  )
}
