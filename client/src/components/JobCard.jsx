  ...
  return (
    <div className='border p-6 shadow rounded'>
      ...
      <div className='flex gap-3 items-center mt-2 text-xs'>
        <span className='px-4 py-1.5 bg-blue-50 border border-blue-200 rounded'>{job.location}</span>
        <span className='px-4 py-1.5 bg-red-50 border border-red-200 rounded'>{job.level}</span>
      </div>
